            ...
            <div className="sign-up-block">
                <div className="sign-up-block-content">
                    <label className="sign-up-block-input"> 
                        <input onChange={(e) => username.onChange(e)}  name="username" className="sign-up-block-el" type="text" placeholder="Enter Username" value={username.value}></input>
                        {username.valid && <div style={{color: 'red'}}>{username.valid}</div>}
                    </label>
                </div>
                <div className="sign-up-block-content">
                    <label className="sign-up-block-input">
                        <input onChange={(e) => email.onChange(e)} name="email" className="sign-up-block-el" type="email" placeholder="Enter Email" value={email.value}></input>
                        {email.valid && <div style={{color: 'red'}}>{email.valid}</div>}
                    </label>
                </div>
                <div className="sign-up-block-content">
                    <label className="sign-up-block-input">
                        <input onChange={(e) => password.onChange(e)} name="password" className="sign-up-block-el" type="password" placeholder="Enter Password" value={password.value}></input>
                ...
                <div>
                    <span className="sign-in-block-span">Already have an account?<Link to="/signin">Sing In</Link></span>
                </div> 
