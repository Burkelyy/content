                ...
                <div className="sign-in-block">
                    <div className="sign-in-block-content">
                        <label className="sign-in-block-input">
                            <input onChange={(e) => email.onChange(e)} name="email" className="sign-in-block-el" type="email" placeholder="Enter Email" value={email.value}></input>
                            {email.valid && <div style={{color: 'red'}}>{email.valid}</div>}
                        </label>
                    </div>
                    <div className="sign-in-block-content">
                        <label className="sign-in-block-input">
                            <input onChange={(e) => password.onChange(e)} name="password" className="sign-in-block-el" type="password" placeholder="Enter Password" value={password.value}></input>
                            {password.valid && <div style={{color: 'red'}}>{password.valid}</div>}
                        </label>
                    </div>  
                    <div>
                        <span className="sign-in-block-span">Don't have an account?<Link to="/signup">Sing Up</Link></span>
                    </div> 
